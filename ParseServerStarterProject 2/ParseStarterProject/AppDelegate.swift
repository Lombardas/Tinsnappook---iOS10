...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let parseConfiguration = ParseClientConfiguration(block: { (ParseMutableClientConfiguration) -> Void in
            ParseMutableClientConfiguration.applicationId = "TinsnapookiOS10"
            ParseMutableClientConfiguration.clientKey = "mymasterkey20160729xyziljh"
            ParseMutableClientConfiguration.server = "http://ec2-54-191-77-189.us-west-2.compute.amazonaws.com/parse"
